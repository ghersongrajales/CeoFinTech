...
public class Ceo_calc_mon_uvr extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ceo_calc_mon_uvr);
    ...
    public void Regresar2(View view) {
        Intent regresar2 = new Intent(this, Ceo_menu_calc.class);
